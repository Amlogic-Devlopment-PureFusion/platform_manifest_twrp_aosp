...
To initialize your local repository using the AOSP trees to build TWRP, use a command like this:
    ...
    repo init -u git@github.com:Amlogic-Devlopment-PureFusion/platform_manifest_twrp_aosp.git -b twrp-12

To initialize a shallow clone, which will save even more space, use a command like this:

    repo init --depth=1 -u git@github.com:Amlogic-Devlopment-PureFusion/platform_manifest_twrp_aosp.git -b twrp-12
